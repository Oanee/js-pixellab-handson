...
console.warn(`
Folosind obiectul person si forEach, afiseaza skillurile din pozitiile impare ale arrayului skills`);
...
console.warn(`
Folosind forEach afiseaza propozitia: "Prietenii mei se numesc xx yyy, xxx yyy si xxx yyy."`);
...
var sumBirth = 0;
person.friends.forEach(function (friend) {
  sumBirth += Math.abs(friend.age - new Date().getFullYear());
});
console.log(sumBirth.toString());
