class Car {
  ...
  createFragment() {
    ...
    // wheel back cap
    this.wheelBackCap = document.createElement('div');
    this.wheelBackCap.classList.add('wheel__cap');
    ...
    // wheel front cap
    this.wheelFrontCap = document.createElement('div');
    this.wheelFrontCap.classList.add('wheel__cap');
