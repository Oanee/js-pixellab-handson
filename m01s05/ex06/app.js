...
console.warn(`
Folosind accesorul salveaza numele complet al persoanei Intr-o variabila si foloseste-l in propozitia: "Eu sunt xxx."`);
...
console.warn(`
Afiseaza porpozitia "Ma numesc xxx yyy, am aa ani si m-am nascut in anul aaaa."`);
console.log(
